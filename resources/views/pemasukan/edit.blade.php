        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body collapse in">
                    ...
                    <form action="{{ route('pemasukan.update',$pemasukan->id_transaksi)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')     
                            <div class="form-body">
                                <div class="form-group">
                                    <label for="id_transaksi">ID Transaksi</label>
                                    <input type="text" class="form-control" id="id_transaksi" name="id_transaksi" value="{{ $pemasukan->id_transaksi }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="userinput2">Rincian</label>
                                    <input type="text" class="form-control " id="rincian_transaksi" name="rincian_transaksi" autofocus value="{{ $pemasukan->rincian_transaksi }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " id="jumlah" name="jumlah" value="{{ $pemasukan->jumlah }}">
                                    <div class="invalid-tooltip" style="color:red;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="/Data_file_Pemasukan/{{$pemasukan->struk}}" class="img-thumbnail img-preview" style="position: relative; height:200px;">
                                    </div>
                                    <div class="col-sm-2">
