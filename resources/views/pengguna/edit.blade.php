                        ...
                        <form class="form" action="{{route('pengguna.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="id_user" name="id_user" value="{{$pengguna->id_user}}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="userinput2">Nama</label>
                                    <input type="text" class="form-control " id="nama" name="nama" autofocus value="{{$pengguna->nama_pengguna}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control " name="provinsi" id="provinsi">
                                        ...
                                        @foreach ($provinsi as $provinsi)
                                            @if($provinsi->id == $pengguna->kd_provinsi)
                                            <option value="{{$provinsi->id}}" selected='selected'>{{$provinsi->nama_provinsi}}</option>
                                            @else
